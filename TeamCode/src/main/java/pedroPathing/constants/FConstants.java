...
public class FConstants {
    static {
        ...
        FollowerConstants.leftFrontMotorName = "mfl";
        FollowerConstants.leftRearMotorName = "mbl";
        FollowerConstants.rightFrontMotorName = "mfr";
        FollowerConstants.rightRearMotorName = "mbr";
